package kabam.rotmg.ui.view.components
{
   ...
   public class PotionSlotMediator extends Mediator
   {
      ...
      [Inject]
      public var view:kabam.rotmg.ui.view.components.PotionSlotView;
      ...
      private function onDrop(param1:DisplayObject) : void
      {
         ...
         var _loc3_:* = DisplayHierarchy.getParentWithTypeArray(param1,InteractiveItemTile,Map,FoodFeedFuseSlot);
