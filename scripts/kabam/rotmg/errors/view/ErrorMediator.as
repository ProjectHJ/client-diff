package kabam.rotmg.errors.view
{
   ...
   public class ErrorMediator extends Mediator
   {
      ...
      {
         var _loc1_:IEventDispatcher = IEventDispatcher(this.loaderInfo[this.UNCAUGHT_ERROR_EVENTS]);
         _loc1_.addEventListener(this.UNCAUGHT_ERROR,this.handleUncaughtError);
      }
      
      private function removeGlobalErrorListener() : void
      {
         var _loc1_:IEventDispatcher = IEventDispatcher(this.loaderInfo[this.UNCAUGHT_ERROR_EVENTS]);
         _loc1_.removeEventListener(this.UNCAUGHT_ERROR,this.handleUncaughtError);
      }
