package kabam.rotmg.arena.view
{
   ...
   public class ArenaQueryPanel extends Panel
   {
      ...
      {
         var _loc1_:int = 15;
         var _loc2_:int = this.infoButton.width + _loc1_ + this.enterButton.width;
         this.infoButton.x = WIDTH / 2 - _loc2_ / 2;
         this.enterButton.x = this.infoButton.x + this.infoButton.width + _loc1_;
