package kabam.rotmg.packages.view
{
   ...
   public class PackageButtonMediator extends Mediator
   {
      ...
      private function onUpdateDuration(param1:int) : void
      {
         this.view.setDuration(param1);
      }
      
      private function onUpdateQuantity(param1:int) : void
      {
         if(param1 <= 0)
         {
            this.view.visible = false;
