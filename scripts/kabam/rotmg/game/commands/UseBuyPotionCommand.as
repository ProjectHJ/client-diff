package kabam.rotmg.game.commands
{
   ...
   public class UseBuyPotionCommand
   {
      ...
      {
         var _loc1_:* = this.player.credits_ >= this.potion.currentCost(this.player.getPotionCount(this.potionId));
      ...
      {
         var _loc1_:int = PotionInventoryModel.getPotionSlot(this.vo.objectId);
         var _loc2_:int = Parameters.data_.contextualPotionBuy;
         this.gsc.useItem(getTimer(),this.player.objectId_,_loc1_,this.potionId,this.player.x_,this.player.y_,_loc2_);
