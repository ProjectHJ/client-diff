package kabam.rotmg.pets.view.components.slot
{
   ...
   public class FeedFuseSlot extends Sprite
   {
      ...
      {
         this.outerSlot = PetsViewAssetFactory.returnPetSlotShape(46,5526612,0,false,true);
         this.innerSlot = PetsViewAssetFactory.returnPetSlotShape(40,5526612,3,false,true);
         this.bg = PetsViewAssetFactory.returnPetSlotShape(46,5526612,0,true,false);
