package kabam.rotmg.editor.view.components.savedialog
{
   ...
   public class TagsInputField extends Sprite
   {
      ...
      public function TagsInputField(param1:String, param2:int = 260, param3:int = 100, param4:Boolean = false)
      {
         super();
         ...
         this.inputText_ = new BaseSimpleText(16,11776947,true,param2,param3);
         this.inputText_.x = !!param4?Number(0):Number(80);
         this.inputText_.y = !!param4?Number(30):Number(0);
         ...
         graphics.drawRect(this.inputText_.x,this.inputText_.y,param2,param3);
         graphics.endFill();
         graphics.lineStyle();
