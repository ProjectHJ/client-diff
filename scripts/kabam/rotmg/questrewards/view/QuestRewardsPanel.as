package kabam.rotmg.questrewards.view
{
   ...
   public class QuestRewardsPanel extends Panel
   {
      ...
      public static function checkQuests() : void
      {
         ...
         var _loc2_:QuestFetchCompleteSignal = StaticInjectorContext.getInjector().getInstance(QuestFetchCompleteSignal);
         if(_loc1_ != null && _loc1_.gameSprite != null && _loc1_.gameSprite.gsc_ != null)
         {
            _loc2_.add(onCheckQuestsComplete);
            _loc1_.gameSprite.gsc_.questFetch();
         }
      }
