package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:com.hurlant.math.BigInteger)
      {
         ...
         this.mph = this.mp >> 15;
         this.um = 1 << com.hurlant.math.BigInteger.DB - 15 - 1;
         this.mt2 = 2 * param1.t;
      }
      ...
      public function convert(param1:com.hurlant.math.BigInteger) : com.hurlant.math.BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(com.hurlant.math.BigInteger.ZERO) > 0)
         {
      ...
      public function reduce(param1:com.hurlant.math.BigInteger) : void
      {
         ...
         while(_loc2_ < this.m.t)
         {
            ...
            _loc4_ = _loc3_ * this.mpl + ((_loc3_ * this.mph + (param1.a[_loc2_] >> 15) * this.mpl & this.um) << 15) & com.hurlant.math.BigInteger.DM;
