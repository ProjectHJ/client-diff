   ...
   public class BitmapUtil
   {
      ...
      public static function amountTransparent(param1:BitmapData) : Number
      {
         ...
         while(_loc3_ < param1.width)
         {
            ...
            {
               _loc5_ = param1.getPixel32(_loc3_,_loc4_) & 4278190080;
               if(_loc5_ == 0)
               {
                  _loc2_++;
               }
      ...
      public static function lineOfSight(param1:BitmapData, param2:IntPoint, param3:IntPoint) : Boolean
      {
         ...
         var _loc13_:int = _loc7_ > _loc9_?int(_loc7_ - _loc9_):int(_loc9_ - _loc7_);
         var _loc14_:int = -(_loc12_ + 1) / 2;
         var _loc15_:int = _loc7_ > _loc9_?-1:1;
         var _loc16_:int = _loc8_ > _loc4_ - 1?int(_loc4_ - 1):int(_loc8_);
         ...
         {
            _loc20_ = _loc15_ > 0?int(-_loc17_ - 1):int(_loc17_ - _loc5_);
         ...
         while(_loc18_ <= _loc16_)
         {
            ...
            else if(_loc17_ >= 0 && _loc17_ < _loc5_ && param1.getPixel(_loc18_,_loc17_) == 0)
            {
               return false;
            }
