package com.company.assembleegameclient.map.partyoverlay
{
   ...
   public class PartyOverlay extends Sprite
   {
      ...
      {
         var _loc3_:com.company.assembleegameclient.map.partyoverlay.PlayerArrow = null;
         super();
         this.map_ = param1;
         this.partyMemberArrows_ = new Vector.<com.company.assembleegameclient.map.partyoverlay.PlayerArrow>(Party.NUM_MEMBERS,true);
         var _loc2_:int = 0;
         while(_loc2_ < Party.NUM_MEMBERS)
         {
            _loc3_ = new com.company.assembleegameclient.map.partyoverlay.PlayerArrow();
      ...
      {
         var _loc6_:com.company.assembleegameclient.map.partyoverlay.PlayerArrow = null;
         var _loc7_:Player = null;
         var _loc8_:int = 0;
         var _loc9_:com.company.assembleegameclient.map.partyoverlay.PlayerArrow = null;
