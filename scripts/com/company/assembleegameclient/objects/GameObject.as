package com.company.assembleegameclient.objects
{
   ...
   public class GameObject extends BasicObject
   {
      ...
      public function damage(param1:int, param2:int, param3:Vector.<uint>, param4:Boolean, param5:Projectile) : void
      {
         ...
         var _loc10_:CharacterStatusText = null;
         var _loc11_:PetsModel = null;
         var _loc12_:PetVO = null;
         ...
         else if(param3 != null)
         {
            ...
            {
               _loc9_ = null;
               if(param5 != null && param5.projProps_.isPetEffect_ && param5.projProps_.isPetEffect_[_loc8_])
               {
                  _loc11_ = StaticInjectorContext.getInjector().getInstance(PetsModel);
                  _loc12_ = _loc11_.getActivePet();
                  if(_loc12_ != null)
                  {
                     _loc9_ = ConditionEffect.effects_[_loc8_];
                     this.showConditionEffectPet(_loc7_,_loc9_.name_);
                     _loc7_ = _loc7_ + 500;
                  }
               }
               else
               {
                  switch(_loc8_)
                  {
                     ...
                     case ConditionEffect.SLOWED:
                        ...
                        {
                           _loc10_ = new CharacterStatusText(this,16711680,3000);
                           _loc10_.setStringBuilder(new LineBuilder().setParams(TextKey.GAMEOBJECT_IMMUNE));
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc8_ < ConditionEffect.NEW_CON_THREASHOLD)
                     {
                        if((this.condition_[ConditionEffect.CE_FIRST_BATCH] | _loc9_.bit_) == this.condition_[ConditionEffect.CE_FIRST_BATCH])
                        {
                           continue;
                        }
                        this.condition_[ConditionEffect.CE_FIRST_BATCH] = this.condition_[ConditionEffect.CE_FIRST_BATCH] | _loc9_.bit_;
                     }
                     else
                     {
                        if((this.condition_[ConditionEffect.CE_SECOND_BATCH] | _loc9_.bit_) == this.condition_[ConditionEffect.CE_SECOND_BATCH])
                        {
                           continue;
                        }
                        this.condition_[ConditionEffect.CE_SECOND_BATCH] = this.condition_[ConditionEffect.CE_SECOND_BATCH] | _loc9_.bit_;
                     }
                     _loc13_ = _loc9_.localizationKey_;
                     this.showConditionEffect(_loc7_,_loc13_);
                     _loc7_ = _loc7_ + 500;
                  }
               }
            }
         ...
         {
            _loc14_ = BloodComposition.getBloodComposition(this.objectType_,this.texture_,this.props_.bloodProb_,this.props_.bloodColor_);
            if(this.dead_)
            {
               map_.addObj(new ExplosionEffect(_loc14_,this.size_,30),x_,y_);
            }
            else if(param5 != null)
            {
               map_.addObj(new HitEffect(_loc14_,this.size_,10,param5.angle_,param5.projProps_.speed_),x_,y_);
            }
            else
            {
               map_.addObj(new ExplosionEffect(_loc14_,this.size_,10),x_,y_);
            }
         }
         if(param2 > 0)
         {
      ...
      protected function drawHpBar(param1:Vector.<IGraphicsData>, param2:int) : void
      {
         ...
         this.hpbarBackPath_.data.push(posS_[0] - _loc4_,posS_[1] + _loc5_,posS_[0] + _loc4_,posS_[1] + _loc5_,posS_[0] + _loc4_,posS_[1] + _loc5_ + _loc6_,posS_[0] - _loc4_,posS_[1] + _loc5_ + _loc6_);
         ...
         if(this.hp_ > 0)
         {
            ...
            this.hpbarPath_.data.push(posS_[0] - _loc4_,posS_[1] + _loc5_,posS_[0] - _loc4_ + _loc8_,posS_[1] + _loc5_,posS_[0] - _loc4_ + _loc8_,posS_[1] + _loc5_ + _loc6_,posS_[0] - _loc4_,posS_[1] + _loc5_ + _loc6_);
      ...
      override public function draw(param1:Vector.<IGraphicsData>, param2:Camera, param3:int) : void
      {
         ...
         if(this.isShocked && !this.isShockedTransformSet)
         {
            ...
            else
            {
               ...
               _loc8_ = CachingColorTransformer.filterBitmapData(_loc8_,new ColorMatrixFilter(MoreColorUtil.greyscaleFilterMatrix));
               _loc4_ = _loc8_;
            }
         ...
         {
            _loc9_ = _loc4_.getPixel32(_loc4_.width / 4,_loc4_.height / 4) | _loc4_.getPixel32(_loc4_.width / 2,_loc4_.height / 2) | _loc4_.getPixel32(_loc4_.width * 3 / 4,_loc4_.height * 3 / 4);
            _loc10_ = _loc9_ >> 24;
            if(_loc10_ != 0)
            {
               hasShadow_ = true;
