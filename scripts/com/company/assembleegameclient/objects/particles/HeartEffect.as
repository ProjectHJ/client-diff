   ...
   public class HeartEffect extends ParticleEffect
   {
      ...
      override public function update(param1:int, param2:int) : Boolean
      {
         ...
         if(!this.bInitialized_)
         {
            ...
            {
               _loc3_ = new HeartParticle(ColorUtil.rangeRandomSmart(this.color_,this.color2_));
               _loc3_.cX_ = x_;
               _loc3_.cY_ = y_;
               _loc5_ = 2 * Math.PI;
               _loc6_ = _loc5_ / this.amount_;
               _loc3_.restart(param1 + _loc6_ * _loc4_ * 1000,param1);
               _loc3_.rad_ = this.rad_;
               this.parts_.push(_loc3_);
               map_.addObj(_loc3_,x_,y_);
               _loc3_.z_ = 0.4 + Math.sin(_loc6_ * _loc4_ * 1.5) * 0.05;
               _loc4_++;
            }
