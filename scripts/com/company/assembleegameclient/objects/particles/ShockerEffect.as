package com.company.assembleegameclient.objects.particles
{
   ...
   public class ShockerEffect extends ParticleEffect
   {
      ...
      private function parseBitmapDataFromImageSet() : void
      {
         ...
         var _loc1_:ImageSet = AssetLibrary.getImageSet("lofiParticlesShocker");
         var _loc3_:uint = 9;
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
            images.push(TextureRedrawer.redraw(_loc1_.images_[_loc2_],this.particleScale,true,0,true));
            _loc2_++;
         }
      }
