   ...
   public class DoubleWall extends GameObject
   {
      ...
      override public function draw(param1:Vector.<IGraphicsData>, param2:Camera, param3:int) : void
      {
         ...
         while(_loc5_ < this.faces_.length)
         {
            ...
            if(_loc8_ == null || _loc8_.texture_ == null || _loc8_ != null && _loc8_.obj_ is DoubleWall && !_loc8_.obj_.dead_)
            {
      ...
      public function rebuild3D() : void
      {
         ...
         this.addWall(_loc1_,_loc2_,2,_loc1_ + 1,_loc2_,2);
         this.addWall(_loc1_ + 1,_loc2_,2,_loc1_ + 1,_loc2_ + 1,2);
         this.addWall(_loc1_ + 1,_loc2_ + 1,2,_loc1_,_loc2_ + 1,2);
         this.addWall(_loc1_,_loc2_ + 1,2,_loc1_,_loc2_,2);
      }
      
      private function addWall(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number) : void
      {
         var _loc7_:Vector.<Number> = new <Number>[param1,param2,param3,param4,param5,param6,param4,param5,param6 - 2,param1,param2,param3 - 2];
         var _loc8_:Face3D = new Face3D(texture_,_loc7_,UVTHEIGHT,true,true);
