package com.company.assembleegameclient.account.ui
{
   ...
   public class TextInputField extends Sprite
   {
      ...
      {
         var _loc2_:uint = !!param1?uint(ERROR_BORDER_COLOR):uint(NORMAL_BORDER_COLOR);
         graphics.clear();
         graphics.lineStyle(2,_loc2_,1,false,LineScaleMode.NORMAL,CapsStyle.ROUND,JointStyle.ROUND);
