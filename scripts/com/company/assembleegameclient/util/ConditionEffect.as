package com.company.assembleegameclient.util
{
   ...
   public class ConditionEffect
   {
      ...
      public static var effects_:Vector.<com.company.assembleegameclient.util.ConditionEffect> = new <com.company.assembleegameclient.util.ConditionEffect>[new com.company.assembleegameclient.util.ConditionEffect("Nothing",0,null,TextKey.CONDITIONEFFECT_NOTHING),new com.company.assembleegameclient.util.ConditionEffect("Dead",DEAD_BIT,null,TextKey.CONDITIONEFFECT_DEAD),new com.company.assembleegameclient.util.ConditionEffect("Quiet",QUIET_BIT,[32],TextKey.CONDITIONEFFECT_QUIET),new com.company.assembleegameclient.util.ConditionEffect("Weak",WEAK_BIT,[34,35,36,37],TextKey.CONDITIONEFFECT_WEAK),new com.company.assembleegameclient.util.ConditionEffect("Slowed",SLOWED_BIT,[1],TextKey.CONDITION_EFFECT_SLOWED),new com.company.assembleegameclient.util.ConditionEffect("Sick",SICK_BIT,[39],TextKey.CONDITIONEFFECT_SICK),new com.company.assembleegameclient.util.ConditionEffect("Dazed",DAZED_BIT,[44],TextKey.CONDITION_EFFECT_DAZED),new com.company.assembleegameclient.util.ConditionEffect("Stunned",STUNNED_BIT,[45],TextKey.CONDITIONEFFECT_STUNNED),new com.company.assembleegameclient.util.ConditionEffect("Blind",BLIND_BIT,[41],TextKey.CONDITIONEFFECT_BLIND),new com.company.assembleegameclient.util.ConditionEffect("Hallucinating",HALLUCINATING_BIT,[42],TextKey.CONDITIONEFFECT_HALLUCINATING),new com.company.assembleegameclient.util.ConditionEffect("Drunk",DRUNK_BIT,[43],TextKey.CONDITIONEFFECT_DRUNK),new com.company.assembleegameclient.util.ConditionEffect("Confused",CONFUSED_BIT,[2],TextKey.CONDITIONEFFECT_CONFUSED),new com.company.assembleegameclient.util.ConditionEffect("Stun Immune",STUN_IMMUNE_BIT,null,TextKey.CONDITIONEFFECT_STUN_IMMUNE),new com.company.assembleegameclient.util.ConditionEffect("Invisible",INVISIBLE_BIT,null,TextKey.CONDITIONEFFECT_INVISIBLE),new com.company.assembleegameclient.util.ConditionEffect("Paralyzed",PARALYZED_BIT,[53,54],TextKey.CONDITION_EFFECT_PARALYZED),new com.company.assembleegameclient.util.ConditionEffect("Speedy",SPEEDY_BIT,[0],TextKey.CONDITIONEFFECT_SPEEDY),new com.company.assembleegameclient.util.ConditionEffect("Bleeding",BLEEDING_BIT,[46],TextKey.CONDITIONEFFECT_BLEEDING),new com.company.assembleegameclient.util.ConditionEffect("Armor Broken Immune",ARMORBROKEN_IMMUNE_BIT,null,TextKey.CONDITIONEFFECT_ARMOR_BROKEN_IMMUNE),new com.company.assembleegameclient.util.ConditionEffect("Healing",HEALING_BIT,[47],TextKey.CONDITIONEFFECT_HEALING),new com.company.assembleegameclient.util.ConditionEffect("Damaging",DAMAGING_BIT,[49],TextKey.CONDITIONEFFECT_DAMAGING),new com.company.assembleegameclient.util.ConditionEffect("Berserk",BERSERK_BIT,[50],TextKey.CONDITIONEFFECT_BERSERK),new com.company.assembleegameclient.util.ConditionEffect("Paused",PAUSED_BIT,null,TextKey.CONDITIONEFFECT_PAUSED),new com.company.assembleegameclient.util.ConditionEffect("Stasis",STASIS_BIT,null,TextKey.CONDITIONEFFECT_STASIS),new com.company.assembleegameclient.util.ConditionEffect("Stasis Immune",STASIS_IMMUNE_BIT,null,TextKey.CONDITIONEFFECT_STASIS_IMMUNE),new com.company.assembleegameclient.util.ConditionEffect("Invincible",INVINCIBLE_BIT,null,TextKey.CONDITIONEFFECT_INVINCIBLE),new com.company.assembleegameclient.util.ConditionEffect("Invulnerable",INVULNERABLE_BIT,[17],TextKey.CONDITIONEFFECT_INVULNERABLE),new com.company.assembleegameclient.util.ConditionEffect("Armored",ARMORED_BIT,[16],TextKey.CONDITIONEFFECT_ARMORED),new com.company.assembleegameclient.util.ConditionEffect("Armor Broken",ARMORBROKEN_BIT,[55],TextKey.CONDITIONEFFECT_ARMOR_BROKEN),new com.company.assembleegameclient.util.ConditionEffect("Hexed",HEXED_BIT,[42],TextKey.CONDITIONEFFECT_HEXED),new com.company.assembleegameclient.util.ConditionEffect("Ninja Speedy",NINJA_SPEEDY_BIT,[0],TextKey.CONDITIONEFFECT_NINJA_SPEEDY),new com.company.assembleegameclient.util.ConditionEffect("Unstable",UNSTABLE_BIT,[56],TextKey.CONDITIONEFFECT_UNSTABLE),new com.company.assembleegameclient.util.ConditionEffect("Darkness",DARKNESS_BIT,[57],TextKey.CONDITIONEFFECT_DARKNESS),new com.company.assembleegameclient.util.ConditionEffect("Slowed Immune",SLOWED_IMMUNE_BIT,null,TextKey.CONDITIONEFFECT_SLOWIMMUNE),new com.company.assembleegameclient.util.ConditionEffect("Dazed Immune",DAZED_IMMUNE_BIT,null,TextKey.CONDITIONEFFECT_DAZEDIMMUNE),new com.company.assembleegameclient.util.ConditionEffect("Paralyzed Immune",PARALYZED_IMMUNE_BIT,null,TextKey.CONDITIONEFFECT_PARALYZEDIMMUNE),new com.company.assembleegameclient.util.ConditionEffect("Petrify",PETRIFIED_BIT,null,TextKey.CONDITIONEFFECT_PETRIFIED),new com.company.assembleegameclient.util.ConditionEffect("Petrify Immune",PETRIFIED_IMMUNE_BIT,null,TextKey.CONDITIONEFFECT_PETRIFY_IMMUNE),new com.company.assembleegameclient.util.ConditionEffect("Pet Disable",PET_EFFECT_ICON_BIT,[27],TextKey.CONDITIONEFFECT_STASIS,true),new com.company.assembleegameclient.util.ConditionEffect("Curse",CURSE_BIT,[58],TextKey.CONDITIONEFFECT_CURSE),new com.company.assembleegameclient.util.ConditionEffect("Curse Immune",CURSE_IMMUNE_BIT,null,TextKey.CONDITIONEFFECT_CURSE_IMMUNE),new com.company.assembleegameclient.util.ConditionEffect("HP Boost",HP_BOOST_BIT,[32],"HP Boost",true),new com.company.assembleegameclient.util.ConditionEffect("MP Boost",MP_BOOST_BIT,[33],"MP Boost",true),new com.company.assembleegameclient.util.ConditionEffect("Att Boost",ATT_BOOST_BIT,[34],"Att Boost",true),new com.company.assembleegameclient.util.ConditionEffect("Def Boost",DEF_BOOST_BIT,[35],"Def Boost",true),new com.company.assembleegameclient.util.ConditionEffect("Spd Boost",SPD_BOOST_BIT,[36],"Spd Boost",true),new com.company.assembleegameclient.util.ConditionEffect("Vit Boost",VIT_BOOST_BIT,[38],"Vit Boost",true),new com.company.assembleegameclient.util.ConditionEffect("Wis Boost",WIS_BOOST_BIT,[39],"Wis Boost",true),new com.company.assembleegameclient.util.ConditionEffect("Dex Boost",DEX_BOOST_BIT,[37],"Dex Boost",true)];
      ...
      public static function getConditionEffectEnumFromName(param1:String) : com.company.assembleegameclient.util.ConditionEffect
      {
