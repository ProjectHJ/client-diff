package com.company.assembleegameclient.ui.board
{
   ...
   class ViewBoard extends Sprite
   {
      ...
      function ViewBoard(param1:String, param2:Boolean)
      {
         ...
         _loc4_.beginFill(0);
         _loc4_.drawRect(0,0,TEXT_WIDTH,TEXT_HEIGHT);
         _loc4_.endFill();
         this.mainSprite_.addChild(_loc3_);
         this.mainSprite_.mask = _loc3_;
         addChild(this.mainSprite_);
         var _loc5_:String = HTMLUtil.escape(param1);
         _loc5_ = _loc5_.replace(URL_REGEX,"<font color=\"#7777EE\"><a href=\"$1\" target=\"_blank\">" + "$1</a></font>");
         ...
         this.boardText_.htmlText = _loc5_;
         ...
         this.w_ = TEXT_WIDTH + (!!_loc6_?26:0);
