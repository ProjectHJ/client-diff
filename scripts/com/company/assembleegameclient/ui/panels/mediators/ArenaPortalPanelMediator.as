package com.company.assembleegameclient.ui.panels.mediators
{
   ...
   public class ArenaPortalPanelMediator extends Mediator
   {
      ...
      {
         var _loc1_:GetBestArenaRunTask = null;
         var _loc2_:EnterArena = null;
         if(this.gameModel.player.nameChosen_)
         {
            this.currentRunModel.saveCurrentUserInfo();
            _loc1_ = this.injector.getInstance(GetBestArenaRunTask);
            _loc1_.start();
            _loc2_ = this.messages.require(GameServerConnection.ENTER_ARENA) as EnterArena;
