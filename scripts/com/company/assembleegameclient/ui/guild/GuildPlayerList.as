package com.company.assembleegameclient.ui.guild
{
   ...
   public class GuildPlayerList extends Sprite
   {
      ...
      public function GuildPlayerList(param1:int, param2:int, param3:String = "", param4:int = 0)
      {
         ...
         var _loc5_:Account = StaticInjectorContext.getInjector().getInstance(Account);
         var _loc6_:Object = {
            "num":param1,
            "offset":param2
         };
         MoreObjectUtil.addToObject(_loc6_,_loc5_.getCredentials());
         ...
         this.listClient_.sendRequest("/guild/listMembers",_loc6_);
      }
      ...
      private function build(param1:XML) : void
      {
         ...
         var _loc7_:* = false;
         var _loc8_:int = 0;
         var _loc9_:MemberListLine = null;
         ...
         _loc2_.beginFill(0);
         _loc2_.drawRect(0,0,MemberListLine.WIDTH,430);
         _loc2_.endFill();
         this.mainSprite_.addChild(_loc3_);
         this.mainSprite_.mask = _loc3_;
         addChild(this.mainSprite_);
         this.listSprite_ = new Sprite();
         var _loc4_:int = 0;
         for each(_loc5_ in param1.Member)
         {
            _loc7_ = this.myName_ == _loc5_.Name;
            _loc8_ = _loc5_.Rank;
            _loc9_ = new MemberListLine(this.offset_ + _loc4_ + 1,_loc5_.Name,_loc5_.Rank,_loc5_.Fame,_loc7_,this.myRank_);
            _loc9_.y = _loc4_ * MemberListLine.HEIGHT;
            this.listSprite_.addChild(_loc9_);
            _loc4_++;
         }
         _loc6_ = GuildUtil.MAX_MEMBERS - (this.offset_ + _loc4_);
         this.openSlotsText_ = new TextFieldDisplayConcrete().setSize(22).setColor(11776947);
         this.openSlotsText_.setStringBuilder(new LineBuilder().setParams(TextKey.GUILD_PLAYER_LIST_OPENSLOTS,{"openSlots":_loc6_}));
         ...
         this.openSlotsText_.y = _loc4_ * MemberListLine.HEIGHT;
