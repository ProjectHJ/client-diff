package com.company.assembleegameclient.mapeditor
{
   ...
   public class MapEditor extends Sprite
   {
      ...
      {
         var _loc2_:SubmitMapForm = null;
         if(!SubmitMapForm.isInitialized())
         {
            _loc2_ = new SubmitMapForm(param1.mapJSON_,param1.mapInfo_,this.model.account);
            this.showCurtain();
            addChild(_loc2_);
            _loc2_.x = (800 - _loc2_.width) / 2;
            _loc2_.y = (600 - _loc2_.height) / 2;
