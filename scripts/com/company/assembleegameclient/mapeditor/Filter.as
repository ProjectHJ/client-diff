package com.company.assembleegameclient.mapeditor
{
   ...
   public class Filter extends Sprite
   {
      ...
      public function setSearch(param1:String) : void
      {
         this._search.inputText_.text = param1;
      }
      
      public function setFilterType(param1:Vector.<String>) : void
      {
         this._filterTypeDropdown.setListItems(param1);
         this._filterTypeDropdown.setIndex(0);
      }
      
      public function enableSearch(param1:Boolean) : void
      {
         this._isSearchEnabled = param1;
         this._search.visible = this._isSearchEnabled;
         this._searchPrompt.visible = this._isSearchEnabled;
      }
      
      public function enableDropDownFilter(param1:Boolean) : void
      {
         this._isValueFilterEnabled = param1;
         this._filterTypeDropdown.visible = this._isValueFilterEnabled;
         this._filterTypeDropdown.setIndex(0);
      }
      
      public function enableValueFilter(param1:Boolean) : void
      {
         this._maxInput.visible = param1;
         this._maxInput.inputText_.text = "";
         this._maxPrompt.visible = param1;
         this._minInput.visible = param1;
         this._minInput.inputText_.text = "";
         this._minPrompt.visible = param1;
      }
      
      public function enableDungeonFilter(param1:Boolean) : void
      {
         this._dungeonDropDown.visible = param1;
      }
      
      private function onFilterTypeChange(param1:Event) : void
      {
