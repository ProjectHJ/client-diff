package com.junkbyte.console
{
   ...
   public class Console extends Sprite
   {
      ...
      private function _onEnterFrame(param1:Event) : void
      {
         ...
         {
            _loc4_ = this._graphing.update(!!stage?Number(stage.frameRate):Number(0));
         }
      ...
      public function addLine(param1:Array, param2:int = 0, param3:* = null, param4:Boolean = false, param5:Boolean = false, param6:int = -1) : void
      {
         ...
         while(_loc9_ < _loc8_)
         {
            _loc7_ = _loc7_ + ((!!_loc9_?" ":"") + this._refs.makeString(param1[_loc9_],null,param5));
            _loc9_++;
         }
         ...
         if(!param5 && param6 > 0)
         {
            _loc7_ = _loc7_ + this._tools.getStack(param6,param2);
         }
