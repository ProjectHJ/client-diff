   ...
   public class MainPanel extends ConsolePanel
   {
      ...
      private function updateFull() : void
      {
         ...
         while(_loc2_)
         {
            ...
            {
               _loc1_ = _loc1_ + this.makeLine(_loc2_,_loc3_);
            }
            _loc2_ = _loc2_.next;
         }
      ...
      private function makeLine(param1:Log, param2:Boolean) : String
      {
         ...
         if(param2)
         {
            _loc3_ = _loc3_ + param1.chStr;
         }
         if(config.showLineNumber)
         {
            _loc3_ = _loc3_ + param1.lineStr;
         }
         if(config.showTimestamp)
         {
            _loc3_ = _loc3_ + param1.timeStr;
         }
      ...
      private function addFilterText(param1:String) : String
      {
         ...
         if(this._filterRegExp)
         {
            ...
            while(_loc2_ != null)
            {
               ...
               if(_loc4_.search("<|>") >= 0)
               {
                  this._filterRegExp.lastIndex = this._filterRegExp.lastIndex - (_loc4_.length - _loc4_.search("<|>"));
               }
      ...
      override public function set height(param1:Number) : void
      {
         ...
         this._traceField.y = !!_loc4_?Number(0):Number(_loc2_);
         ...
         this._scroll.y = !!_loc4_?Number(6):Number(_loc2_ + 4);
      ...
      private function updateTraceFHeight() : void
      {
         ...
         this._traceField.y = !!_loc1_?Number(0):Number(txtField.y + txtField.height - 6);
      ...
      private function updateCmdHint(param1:Event = null) : void
      {
         ...
         if(_loc2_ && config.commandLineAutoCompleteEnabled && console.remoter.remoting != Remoting.RECIEVER)
         {
            try
            {
      ...
      private function updateCLSize() : void
      {
         ...
         if(this._cmdPrefx.width > 120 || this._cmdPrefx.width > _loc1_)
         {
            ...
            this._cmdPrefx.width = _loc1_ > 120?Number(120):Number(_loc1_);
